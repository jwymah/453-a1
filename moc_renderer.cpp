...
const QMetaObject Renderer::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_Renderer.data,
...
void *Renderer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QOpenGLFunctions_4_2_Core"))
        return static_cast< QOpenGLFunctions_4_2_Core*>(const_cast< Renderer*>(this));
